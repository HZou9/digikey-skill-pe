...
def _mosfet_products() -> list:
    return [
        # --- Infineon CoolSiC G2 ---
        {
            "DigiKeyPartNumber": "IMLT65R015M2HXTMA1-ND",
            "ManufacturerPartNumber": "IMLT65R015M2H",
            "Manufacturer": "Infineon Technologies",
            "Description": "MOSFET SIC N-CH 650V 15MOHM HDSOP-16",
            "UnitPrice": 7.42,
            "QuantityAvailable": 2800,
            "DatasheetUrl": "https://www.infineon.com/dgdl/Infineon-IMLT65R015M2H-DataSheet-v02_00-EN.pdf",
            "ProductUrl": "https://www.digikey.com/en/products/detail/infineon/IMLT65R015M2HXTMA1/23018586",
            "Parameters": [
                {"Name": "FET Type", "Value": "N-Channel"},
                {"Name": "Technology", "Value": "SiC (Silicon Carbide)"},
                {"Name": "Drain-Source Voltage (Vdss)", "Value": "650V"},
                {"Name": "Current - Continuous Drain (Id) @ 25°C", "Value": "142A"},
                {"Name": "Rds On (Max) @ Id, Vgs", "Value": "15mΩ @ 71A, 18V"},
                {"Name": "Vgs(th) (Max) @ Id", "Value": "4.5V @ 5mA"},
                {"Name": "Gate Charge (Qg) (Max) @ Vgs", "Value": "79nC @ 18V"},
                {"Name": "Input Capacitance (Ciss) (Max) @ Vds", "Value": "2500pF @ 400V"},
                {"Name": "Power Dissipation (Max)", "Value": "600W"},
                {"Name": "Operating Temperature", "Value": "-55°C ~ 175°C"},
                {"Name": "Mounting Type", "Value": "Surface Mount"},
                {"Name": "Package / Case", "Value": "PG-HDSOP-16"},
            ],
            "RoHSStatus": "RoHS Compliant",
            "LeadStatus": "Lead Free",
        },
        {
            "DigiKeyPartNumber": "IMZA65R027M2HXKSA1-ND",
            "ManufacturerPartNumber": "IMZA65R027M2H",
            "Manufacturer": "Infineon Technologies",
            "Description": "MOSFET SIC N-CH 650V 27MOHM TO247-4",
            "UnitPrice": 6.15,
            "QuantityAvailable": 5400,
            "DatasheetUrl": "https://www.infineon.com/dgdl/Infineon-IMZA65R027M2H-DataSheet-v02_00-EN.pdf",
            "ProductUrl": "https://www.digikey.com/en/products/detail/infineon/IMZA65R027M2HXKSA1/22456789",
            "Parameters": [
                {"Name": "FET Type", "Value": "N-Channel"},
                {"Name": "Technology", "Value": "SiC (Silicon Carbide)"},
                {"Name": "Drain-Source Voltage (Vdss)", "Value": "650V"},
                {"Name": "Current - Continuous Drain (Id) @ 25°C", "Value": "83A"},
                {"Name": "Rds On (Max) @ Id, Vgs", "Value": "27mΩ @ 42A, 18V"},
                {"Name": "Vgs(th) (Max) @ Id", "Value": "4.5V @ 5mA"},
                {"Name": "Gate Charge (Qg) (Max) @ Vgs", "Value": "55nC @ 18V"},
                {"Name": "Input Capacitance (Ciss) (Max) @ Vds", "Value": "1700pF @ 400V"},
                {"Name": "Power Dissipation (Max)", "Value": "326W"},
                {"Name": "Operating Temperature", "Value": "-55°C ~ 175°C"},
                {"Name": "Mounting Type", "Value": "Through Hole"},
                {"Name": "Package / Case", "Value": "TO-247-4"},
            ],
            "RoHSStatus": "RoHS Compliant",
            "LeadStatus": "Lead Free",
        },
        # --- STMicroelectronics ---
        {
            "DigiKeyPartNumber": "SCTW90N65G2VAG-ND",
            "ManufacturerPartNumber": "SCTW90N65G2VAG",
            "Manufacturer": "STMicroelectronics",
            "Description": "MOSFET SIC N-CH 650V 18MOHM HiP247",
            "UnitPrice": 7.20,
            "QuantityAvailable": 3600,
            "DatasheetUrl": "https://www.st.com/resource/en/datasheet/sctw90n65g2v.pdf",
            "ProductUrl": "https://www.digikey.com/en/products/detail/st/SCTW90N65G2VAG/18765432",
            "Parameters": [
                {"Name": "FET Type", "Value": "N-Channel"},
                {"Name": "Technology", "Value": "SiC (Silicon Carbide)"},
                {"Name": "Drain-Source Voltage (Vdss)", "Value": "650V"},
                {"Name": "Current - Continuous Drain (Id) @ 25°C", "Value": "90A"},
                {"Name": "Rds On (Max) @ Id, Vgs", "Value": "18mΩ @ 45A, 18V"},
                {"Name": "Vgs(th) (Max) @ Id", "Value": "4.0V @ 5mA"},
                {"Name": "Gate Charge (Qg) (Max) @ Vgs", "Value": "88nC @ 18V"},
                {"Name": "Input Capacitance (Ciss) (Max) @ Vds", "Value": "2350pF @ 400V"},
                {"Name": "Power Dissipation (Max)", "Value": "350W"},
                {"Name": "Operating Temperature", "Value": "-55°C ~ 200°C"},
                {"Name": "Mounting Type", "Value": "Through Hole"},
                {"Name": "Package / Case", "Value": "HiP247"},
            ],
            "RoHSStatus": "RoHS Compliant",
            "LeadStatus": "Lead Free",
        },
        ...
        {
            "DigiKeyPartNumber": "C3M0015065D-ND",
            "ManufacturerPartNumber": "C3M0015065D",
            "Manufacturer": "Wolfspeed",
            "Description": "MOSFET SIC N-CH 650V 15MOHM TO247-3",
            "UnitPrice": 10.80,
            "QuantityAvailable": 1890,
            "DatasheetUrl": "https://assets.wolfspeed.com/uploads/2024/01/Wolfspeed_C3M0015065D_data_sheet.pdf",
            "ProductUrl": "https://www.digikey.com/en/products/detail/wolfspeed/C3M0015065D/12345678",
            "Parameters": [
                {"Name": "FET Type", "Value": "N-Channel"},
                {"Name": "Technology", "Value": "SiC (Silicon Carbide)"},
                {"Name": "Drain-Source Voltage (Vdss)", "Value": "650V"},
                {"Name": "Current - Continuous Drain (Id) @ 25°C", "Value": "120A"},
                {"Name": "Rds On (Max) @ Id, Vgs", "Value": "15mΩ @ 60A, 15V"},
                {"Name": "Vgs(th) (Max) @ Id", "Value": "4.5V @ 10mA"},
                {"Name": "Gate Charge (Qg) (Max) @ Vgs", "Value": "110nC @ 15V"},
                {"Name": "Input Capacitance (Ciss) (Max) @ Vds", "Value": "3200pF @ 400V"},
                {"Name": "Power Dissipation (Max)", "Value": "300W"},
                {"Name": "Operating Temperature", "Value": "-55°C ~ 175°C"},
                {"Name": "Mounting Type", "Value": "Through Hole"},
                {"Name": "Package / Case", "Value": "TO-247-3"},
            ],
        ...
        # --- Infineon CoolSiC G1 (Si MOSFET reference) ---
        {
